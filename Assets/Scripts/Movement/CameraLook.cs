...
public class CameraLook : MonoBehaviour
{
    ...
    {
        LookAtJarvis.AddListener(FixLook);
        LookFree.AddListener(FreeLook);
    }
    ...
    void Update()
    {
        ...
        {
            target = Quaternion.LookRotation(LookAtObject.transform.position - this.transform.position);
            this.transform.rotation = Quaternion.RotateTowards(this.transform.rotation, target, sens * Time.deltaTime);
        }
    }
}